...
//            ceiling returns the element >= to the element passed
//       both ceiling higher return the highest element to if c is not in the NavigableSet
//       both return null if c is not in the set and there is nothing higher to c
            System.out.printf("ceiling(%s)=%s%n", c.getName(), fullSet.ceiling(c));
//            higher returns the element that is > than the element passed not one that is ==
...
//        any change made to the descending set will be reflected in the parent set
...
//        all contacts less than the element passed
