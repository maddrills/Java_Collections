...
//    order is oder of insertion
    private static Map<String, Purchase> purchases = new LinkedHashMap<>();

//    sorted by key type
//    here we dont have to pass a comparator to its constructor because the key is of type string so the default comparator would do
...
//        keying date of purchase
        NavigableMap<LocalDate,List<Purchase>> datedPurchases = new TreeMap<>();

        for (Purchase p : purchases.values() ) {
//            compute adds a value according to a condition specified by us
